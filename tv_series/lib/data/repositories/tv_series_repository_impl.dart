...
;      return Right(result.toEntity());
  ...
  @override
  Future<Either<Failure, List<TvSeries>>> getTvSeriesRecommendations({required int id}) async {
    try {
  ...
  @override
  Future<Either<DatabaseFailure, bool>> insertWatchlist(TvSeriesDetail tvSeries) async {
    try {
      final result = await localDataSource.insertWatchlist(TvSeriesModel.fromTvSeriesDetail(tvSeries));
      return Right(result);
